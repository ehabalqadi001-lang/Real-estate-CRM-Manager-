...
export default function CompanyDashboardError({
  ...
  return (
    <div className="flex h-[80vh] flex-col items-center justify-center p-8 text-center" dir="rtl">
      <div className="bg-red-50 p-8 rounded-3xl border border-red-100 max-w-lg w-full">
        ...
        <button
          onClick={() => reset()}
          className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-xl font-bold flex items-center justify-center gap-2 mx-auto transition-all"
        >
          <RefreshCcw size={18} />
          إعادة تحميل اللوحة
        </button>
