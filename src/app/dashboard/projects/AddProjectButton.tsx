...
export default function AddProjectButton() {
  ...
  return (
    <>
      ...
      >
        <Plus size={15} /> {t('إضافة مشروع', 'Add Project')}
      </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-4 sm:p-6" dir={dir}>
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-lg font-black text-slate-900">{t('مشروع جديد', 'New Project')}</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="text-xs font-bold text-slate-600 block mb-1">{t('الموقع / المنطقة', 'Location / Area')}</label>
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-bold text-slate-600 block mb-1">{t('تاريخ الإطلاق', 'Launch Date')}</label>
                ...
                <div>
                  <label className="text-xs font-bold text-slate-600 block mb-1">{t('تاريخ التسليم', 'Delivery Date')}</label>
              ...
              <div className="flex gap-3 pt-2">
                <button type="submit" disabled={pending}
                  ...
                  {pending ? t('جاري الحفظ...', 'Saving...') : t('حفظ المشروع', 'Save Project')}
                </button>
