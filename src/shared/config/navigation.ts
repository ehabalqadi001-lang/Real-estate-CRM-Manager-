...
export const dashboardNavigation: NavigationGroup[] = [
  {
    ...
    items: [
      ...
      { title: 'ذكاء السوق', titleKey: 'marketIntel', href: '/dashboard/market-intelligence', permission: 'report.view.own', icon: LineChart },
      { title: 'تقارير العملاء', titleKey: 'clientReports', href: '/dashboard/client-reports', permission: 'report.view.own', icon: SendHorizonal },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'مطالبات البيع', titleKey: 'salesClaims', href: '/dashboard/sales-claims', permission: 'deal.view.own', icon: FileCheck },
